...
program. The program was supposed to do the following: in the given string, consisting of uppercase and lowercase
Latin letters, it:
...
public class StringTask {
    public String perform(String word) {
        return Arrays.stream(word.replaceAll("[aeiouyAEIOUY]+", "").split("")).
                map(s -> "." + s.toLowerCase()).
